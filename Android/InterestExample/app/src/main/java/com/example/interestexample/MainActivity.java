package com.example.interestexample;
...
//                Toast.makeText(MainActivity.this, "p "+p+ " n "+n+" r "+r , Toast.LENGTH_SHORT).show();
                if(p==0||n==0||r==0){
                    Toast.makeText(MainActivity.this, "You Entered 0 in above fields", Toast.LENGTH_SHORT).show();
                }
                else {
                    simpleInterest=(double) (p * n * r) / 100;
                    Toast.makeText(MainActivity.this, "Simple Interest= " + simpleInterest, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
